...
$domande = [
    ...
    [
        ...
        <ul>
        <li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.<br> <br>
        </li>
        <li>
        </li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.<br> <br>
        </ul>
        </li>
        <li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.<br> <br>
        </li>
        </0l>
